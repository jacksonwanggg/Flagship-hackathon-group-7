      ...
      <div className="hero-content text-center bg-rose-600">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row m-2">
            <div className="pb-3 text-white">I just did some pushups</div>
          ...
          <div className="max-w-md bg-transparent">
            <figure>
              <video width="600" autoPlay className="rounded-xl border-white border-2">
...
const Dashboard: React.FC<any> = ({ post }) => {
	return (
...
>>>>>>> fc31bbb5277a7e723f814a7cc32392b892882945
};
