            ...
            <div key={index} className="carousel-item-content rounded-lg mb-6">
                ...
                <Image
                  ...
                  className={`transition-transform duration-500 ${
                    isShrinking && currentPetIndex === index
                      ? "scale-0"
                      : "scale-100"
                  } w-full rounded-xl aspect-square object-cover border-4 border-gray-300`}
              ...
              <div className="flex justify-center mt-4">
                <button
                  ...
                  className="feedGradientEffect text-white text-2xl bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg w-64 py-2.5 text-center mb-2"
                >
                  FEED
                </button>
              </div>
