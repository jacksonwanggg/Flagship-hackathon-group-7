        ...
        >
          {pets.map((pet, index) => (
            <div key={index} className="carousel-item-content rounded-lg mb-6">
              <div className={`transition-transform duration-500 ${isShrinking && currentPetIndex === index ? 'scale-0' : 'scale-100'} image-container mb-4`}>
                <Image
              ...
              <h2 className="text-4xl font-bold text-center mb-4 experience-header">{pet.experience}/100 EXP</h2>
            </div>
          ))}
        </Carousel>
      ) : (
